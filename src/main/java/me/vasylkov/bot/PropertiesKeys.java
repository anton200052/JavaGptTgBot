...
public enum PropertiesKeys
{
    ...
    CONFIG_SPEECH_TOKEN("config.speechToken"),
    ...
    CHAT_TRANSCRIPTION_RESULT("chat.transcriptionResult"),
    ...
    ERROR_VOICE_DURATION_LIMIT("error.voiceDurationLimit"),
    ...
    ERROR_NO_GPT4_ACCESS("error.noGpt4Access"),
    ERROR_NO_VOICE_ACCESS("error.noVoiceAccess"),
    ERROR_USERNAME_NOT_AVAILABLE("error.usernameNotAval"),
    ERROR_FAILED_TO_RECOGNIZE_SPEECH("error.failedToRecognizeSpeech"),
